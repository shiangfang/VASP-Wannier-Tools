...
knum_tot=knum_tot(1);
[ Hmat_SOC ] = Ham_generate_SO_term( soc_m,soc_x );


tb_bands=zeros(22,knum_tot);
tb_vecs=zeros(22,22,knum_tot);
for ind = 1:knum_tot
    ind
    k_now=all_kpts(ind,:);
    Hmat=zeros(22);
    
    [Hmat0 ] = Ham_TBH_monolayer( k_now,mono_tbh_parm,a1,a2 );
    
    Hmat(1:11,1:11)=Hmat0(:,:);
    Hmat(12:22,12:22)=Hmat0(:,:);
    Hmat=Hmat+Hmat_SOC;
